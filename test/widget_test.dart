...
import 'package:app_06_voice_memo_tagger/app.dart';
import 'package:app_06_voice_memo_tagger/services/supabase_service.dart';

void main() {
  testWidgets('회원가입 후 메모 항목을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('음성메모 자동 태그 정리'), findsWidgets);
