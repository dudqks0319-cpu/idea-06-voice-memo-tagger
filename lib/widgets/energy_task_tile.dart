    ...
    return Card(
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            Text('필요 우선순위 ${task.priorityLevel}/5 · 예상 ${task.memoLengthSec}분'),
        ...
        trailing: Wrap(
          ...
          children: [
            Chip(
              label: Text('E${task.priorityLevel}'),
              backgroundColor: _energyColor(task.priorityLevel).withValues(alpha: 0.15),
            ),
