...
class StatsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalMinutes = all.fold<int>(0, (s, t) => s + t.memoLengthSec);
    final doneMinutes = done.fold<int>(0, (s, t) => s + t.memoLengthSec);
    ...
    for (final task in all) {
      final idx = task.priorityLevel.clamp(1, 5) - 1;
      energyBuckets[idx] += 1;
    }
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const Text('메모 시간 진행률', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('필요 우선순위 분포', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                for (var i = 0; i < 5; i++)
                  Padding(
