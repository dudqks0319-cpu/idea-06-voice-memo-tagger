...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    _defaultEnergy = profile?.defaultPriorityLevel ?? 3;
    _dailyFocus = profile?.dailyReviewMinutes ?? 180;
    _notifications = profile?.notificationsEnabled ?? true;
  }

  Future<void> _save() async {
    await widget.taskProvider.updateSettings(
      defaultPriorityLevel: _defaultEnergy,
      dailyReviewMinutes: _dailyFocus,
